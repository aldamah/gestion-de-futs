...
class Retour(models.Model):
    ...
    total_retour = fields.Integer(compute='_get_total')
    ...
    def create(self, vals):
        ...
        return super(Retour, self).create(vals)
    ...
    def unlink(self):
        ...
        return super(Retour, self).unlink()

    @api.multi
    def copy(self, default=None):
        new_po = super(Retour, self).copy(default=default)
    ...
    def _track_subtype(self, init_values):
        ...
        return super(Retour, self)._track_subtype(init_values)
...
class PurchaseOrderLine(models.Model):
    ...
    order_id = fields.Many2one('gestiondefuts.retour', string='Order Reference', index=True, required=True, ondelete='cascade')
